...
function HeroSection() {
  ...
  return (
    <BackgroundBeamsWithCollision className="w-full h-screen flex items-center justify-center">
      <section className="relative z-10 w-full">
        <div className="container mx-auto px-4 flex flex-col justify-center h-full pb-16">
          <motion.div
            ref={ref1}
            ...
            className={cn(
              "text-center text-5xl leading-tight md:text-[64px] md:leading-[72px] font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-0 mb-6",
