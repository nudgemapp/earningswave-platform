...
const AIEarningsAnalysis: React.FC<AIEarningsAnalysisProps> = ({ report }) => {
  ...
  return (
    <Card className="w-full shadow-lg bg-white dark:bg-slate-900 dark:shadow-slate-800/50">
      <CardHeader className="space-y-2">
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-xl font-bold text-gray-900 dark:text-gray-200">
              {`Q${quarterNum} ${new Date(
                report.fiscalDateEnding
              ).getFullYear()} Analysis`}
            </CardTitle>
