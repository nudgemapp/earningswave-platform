...
export const EARNINGS_CALENDAR: EarningsCalendar = {
  ...
  "2025-02-03": [
    // After Market Close (AMC)
    {
      ...
      marketTime: "AMC",
      earningsTime: "16:15",
      earningsEstimate: "$10.11",
      revenueEstimate: "$4.54 Bil",
      revenueGrowth: "24.1%",
    },
    {
      symbol: "NXPI",
      marketTime: "AMC",
      earningsTime: "16:10",
      earningsEstimate: "$2.62",
      revenueEstimate: "$3.10 Bil",
      revenueGrowth: "-9.4%",
    },
  ],
  "2025-02-04": [
    // Before Market Open (BMO)
    {
      ...
      earningsTime: "07:00",
      earningsEstimate: "$1.11",
      revenueEstimate: "$8.30 Bil",
      revenueGrowth: "3.4%",
    },
    {
      symbol: "SPOT",
      marketTime: "BMO",
      earningsEstimate: "$1.99",
      revenueEstimate: "$4.41 Bil",
      revenueGrowth: "11.6%",
    },
    {
      symbol: "PFE",
    ...
    },
    {
      ...
      marketTime: "BMO",
      earningsTime: "06:30",
      earningsEstimate: "$1.80",
      revenueEstimate: "$15.71 Bil",
      revenueGrowth: "7.4%",
    },
    {
      symbol: "PEP",
      marketTime: "BMO",
      earningsTime: "06:00",
      earningsEstimate: "$1.95",
      revenueEstimate: "$28.63 Bil",
      revenueGrowth: "2.8%",
    },
    {
      symbol: "EL",
      marketTime: "BMO",
      earningsTime: "06:30",
      earningsEstimate: "$0.32",
      revenueEstimate: "$3.99 Bil",
      revenueGrowth: "-6.8%",
    },
    {
      symbol: "CNC",
    ...
    },
    {
      ...
      marketTime: "BMO",
      earningsTime: "06:40",
      earningsEstimate: "$0.28",
      revenueEstimate: "$31.93 Bil",
      revenueGrowth: "-13.3%",
    },
    {
      symbol: "MPLX",
    ...
    },
    {
      ...
      marketTime: "BMO",
      earningsTime: "07:00",
      earningsEstimate: "$1.47",
      revenueEstimate: "$2.61 Bil",
      revenueGrowth: "17.7%",
    },
    // After Market Close (AMC)
    {
    ...
    },
    {
      ...
      marketTime: "AMC",
      earningsTime: "16:05",
      earningsEstimate: "$2.89",
      revenueEstimate: "$2.52 Bil",
      revenueGrowth: "29.6%",
    },
    {
      symbol: "FMC",
    ...
    },
    {
      ...
      marketTime: "AMC",
      earningsTime: "16:05",
      earningsEstimate: "$3.42",
      revenueEstimate: "$1.61 Bil",
      revenueGrowth: "5.3%",
    },
    {
      symbol: "UNM",
  ...
  "2025-02-05": [
    ...
    },
    {
      ...
      marketTime: "BMO",
      earningsTime: "00:45",
      earningsEstimate: "$0.81",
      revenueEstimate: "$24.47 Bil",
      revenueGrowth: "-15.8%",
    },
    {
      symbol: "BSX",
    ...
    },
    {
      ...
      marketTime: "BMO",
      earningsTime: "07:00",
      earningsEstimate: "$1.59",
      revenueEstimate: "$2.35 Bil",
      revenueGrowth: "15.4%",
    },
    {
      symbol: "SWK",
    ...
    },
    {
      ...
      marketTime: "AMC",
      earningsTime: "16:00",
      earningsEstimate: "$2.02",
      revenueEstimate: "$1.00 Bil",
      revenueGrowth: "4.5%",
    },
    {
      symbol: "WFRD",
    ...
    },
    {
      ...
      marketTime: "AMC",
      earningsTime: "16:15",
      earningsEstimate: "$0.34",
      revenueEstimate: "$3.86 Bil",
      revenueGrowth: "4.1%",
    },
    {
      symbol: "MCK",
      marketTime: "AMC",
      earningsTime: "16:10",
      earningsEstimate: "$8.28",
      revenueEstimate: "$94.80 Bil",
      revenueGrowth: "17.2%",
    },
    {
      symbol: "ALL",
      marketTime: "AMC",
      earningsTime: "17:30",
      earningsEstimate: "$5.70",
      revenueEstimate: "$16.38 Bil",
      revenueGrowth: "10.4%",
    },
    {
      symbol: "LSAK",
    ...
    },
    {
      ...
      marketTime: "AMC",
      earningsTime: "16:00",
      earningsEstimate: "$1.01",
      revenueEstimate: "$296.52 Mil",
      revenueGrowth: "-0.3%",
    },
    {
      symbol: "MOH",
      marketTime: "AMC",
      earningsTime: "16:15",
      earningsEstimate: "$5.81",
      revenueEstimate: "$10.50 Bil",
      revenueGrowth: "16.0%",
    },
  ],
  "2025-02-06": [
    // Before Market Open (BMO)
    {
      ...
      marketTime: "BMO",
      earningsTime: "06:45",
      earningsEstimate: "$5.49",
      revenueEstimate: "$14.15 Bil",
      revenueGrowth: "51.3%",
    },
    {
      symbol: "BMY",
    ...
    },
    {
      ...
      marketTime: "BMO",
      earningsTime: "06:30",
      earningsEstimate: "$2.98",
      revenueEstimate: "$5.11 Bil",
      revenueGrowth: "8.6%",
    },
    {
      symbol: "ICE",
    ...
    },
    {
      ...
      marketTime: "AMC",
      earningsTime: "16:05",
      earningsEstimate: "$0.21",
      revenueEstimate: "$772.08 Mil",
      revenueGrowth: "-6.1%",
    },
  ],
};
